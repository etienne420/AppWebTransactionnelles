...
<head>
    <meta charset="UTF-8">
    <title>Récits - Projet 1</title>
</head>

<body>
    <h1>Récits utilisateurs</h1>

    <h2>Récit 1 — Ajouter un jeu à ma librairie</h2>
    <p>
        Comme joueur, je veux pouvoir ajouter un jeu à ma librairie afin de gérer ma collection de jeux vidéo.
    </p>
    ...
    <h2>Récit 2 — Consulter les jeux</h2>
    <p>
        Comme joueur, je veux pouvoir consulter les jeux disponibles afin de découvrir les jeux de la plateforme.
    </p>
    ...
    <h2>Récit 3 — Créer un compte</h2>
    <p>
        Comme visiteur, je veux pouvoir créer un compte afin d'utiliser les fonctionnalités réservées aux joueurs.
    </p>
    ...
    <h2>Récit 4 — Se connecter</h2>
    <p>
        Comme joueur, je veux pouvoir me connecter afin d'accéder à ma librairie personnelle.
    </p>
    ...
    <h2>Récit 5 — Évaluer un jeu</h2>
    <p>
        Comme joueur, je veux pouvoir évaluer un jeu afin de partager mon opinion avec les autres utilisateurs.
    </p>
    ...
    <h2>Récit 6 — Emprunter un jeu</h2>
    <p>
        Comme joueur, je veux pouvoir emprunter un jeu afin de pouvoir l'utiliser temporairement.
    </p>
    ...
    <h2>Récit 7 — Retourner un jeu</h2>
    <p>
        Comme joueur, je veux pouvoir retourner un jeu emprunté afin de le rendre disponible aux autres joueurs.
    </p>
    ...
    <h2>Récit 8 — Gérer les jeux</h2>
    <p>
        Comme administrateur, je veux pouvoir gérer les jeux afin de maintenir les informations de la plateforme à jour.
    </p>
